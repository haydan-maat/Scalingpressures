...
//   FROM_EMAIL="Maat Partners <results@updates.maatpartners.co.uk>"
...
export default async (req, context) => {
  ...
  const FROM_EMAIL = process.env.FROM_EMAIL || "Maat Partners <onboarding@resend.dev>";
...
function buildEmailHtml(opts) {
  ...
  return (
    ...
    OBSIDIAN +
    '; padding: 24px 28px;">' +
    '<div style="font-family: Manrope, Arial, sans-serif; color: #ffffff; font-size: 13px; letter-spacing: 0.04em; text-transform: uppercase; opacity: 0.8;">Maat Partners</div>' +
    ...
    "Maat Partners — sent because you completed the Scaling Pressure Check." +
    "</td></tr>" +
    "</table></div>"
  );
}
